...
const comprador1 = { nombre: "Ana Lucia", edad: 39, correo: "analucia12@yahoo.es"}

comprador1.edad = 65

console.log(comprador1.nombre);

//personaje de los simpsons

function carroMar (marca, referencia, color,){
        this.marca = marca;
        this.referencia = referencia;
        this.color = color;
}

const carro1 = new carroMar ("ford", "bronco", "azul medianoche")
